...
namespace LPCMSWeb.Cores
{
    public class ValidateCodeHelper
    {
        ...
        //protected byte[] Page_Load(object sender, EventArgs e)
        public byte[] Page_Load()
        {
            ////取消缓存
            ...
            //}
            //生成验证码
            return this.CreateCheckCodeImage(GenerateCheckCode());
        }
        ...
        private byte[] CreateCheckCodeImage(string checkCode)
        {
            ...
            try
            {
                ...
                //g.DrawString(checkCode, font, brush,  cySpace, 1);
                //画图片的前景噪音点
                for (int i = 0; i < 100; i++)
                {
